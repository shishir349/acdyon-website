      ...
      <div className="container-wide">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h2 className="text-4xl lg:text-5xl font-heading text-slate-900 leading-tight">
              The Standard for{" "}
              <span className="text-gradient-blue">Executive</span>{" "}
              Global Learning
            </h2>
            <p className="text-slate-500 text-lg leading-relaxed">
              We are not a typical EdTech platform. AcdyOn is a curated ecosystem built for professionals who demand the highest standard in education, credibility, and career impact.
            </p>
            ...
            {benefits.map((benefit, i) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-white border border-slate-200 rounded-2xl p-5 hover:shadow-md hover:border-blue-200 transition-all duration-300 group"
                >
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 rounded-xl gradient-royal flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
